public class Restaurent {
    ...
    // Constructor
    public Restaurent(String name, String location, String[] foodItems) {
        this.name = name;
...
// Main Class to Test
 class Main {
    public static void main(String[] args) {
        ...
        Restaurent restaurant1 = new Restaurent("Italian Delight", "Downtown", foodItems1);
        Restaurent restaurant2 = new Restaurent("Tokyo Treats", "Uptown", foodItems2);
